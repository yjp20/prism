...
@stoplight/prism-cli/3.0.0-pre.0 darwin-x64 node-v11.13.0
$ prism --help [COMMAND]
USAGE
  $ prism COMMAND
...
...
_See code: [src/commands/mock.ts](https://github.com/stoplightio/prism/blob/v3.0.0-pre.0/src/commands/mock.ts)_
...
_See code: [src/commands/server.ts](https://github.com/stoplightio/prism/blob/v3.0.0-pre.0/src/commands/server.ts)_
<!-- commandsstop -->
