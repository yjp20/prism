...
@stoplight/prism-cli/3.0.0-beta.5 darwin-x64 node-v12.5.0
$ prism --help [COMMAND]
USAGE
  $ prism COMMAND
...
...
_See code: [dist/commands/mock.ts](https://github.com/stoplightio/prism/blob/v3.0.0-beta.5/dist/commands/mock.ts)_
<!-- commandsstop -->
