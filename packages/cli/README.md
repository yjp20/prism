...
@stoplight/prism-cli/3.0.0-alpha.13 darwin-x64 node-v12.4.0
$ prism --help [COMMAND]
USAGE
  $ prism COMMAND
...
...
_See code: [src/commands/mock.ts](https://github.com/stoplightio/prism/blob/v3.0.0-alpha.13/src/commands/mock.ts)_
<!-- commandsstop -->
